  ...
  return (
    ...
    {/* this is the change color button a dummy button */}
      <Grid container justifyContent="flex-end" alignItems="center" sx={{ p: 2 }}>
        <Button onClick={colorMode.toggleColorMode}>change color</Button> </Grid>
      ...
      >
        ...
        <Typography my={2} variant='body1' color={'text.secondary'} align='center'>You currently have no project in your list</Typography>
